...
class CraftingConsumptionService
{
     ...
     */
    public function consume(int $playerId, array $resolvedSlots): void
    {
        foreach ($resolvedSlots as $slot) {
            ...
            if ($kind === 'item_instance') {
                $this->consumeItemInstance($playerId, $slot);
            }
        }
    }
    ...
    private function consumeItemInstance(int $playerId, array $slot): void
    {
