...
return function (PDO $pdo): void {
    ...
    foreach ([
        ...
        'simple_magnifier' => [
            'Simple Magnifier',
            'Basic investigation tool used to reveal clues without consuming the object.',
            'tool',
            'metal',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'magnifier', 'durability' => 60], JSON_THROW_ON_ERROR),
        ],
        'simple_hatchet' => [
            'Simple Hatchet',
            'Basic cutting tool used for wood, branches and rough vegetation.',
            'tool',
            'wood',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'hatchet', 'durability' => 75], JSON_THROW_ON_ERROR),
        ],
        'simple_shears' => [
            'Simple Shears',
            'Basic botanical tool used to trim leaves, herbs and delicate fibers.',
            'tool',
            'metal',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'shears', 'durability' => 60], JSON_THROW_ON_ERROR),
        ],
        'simple_tweezers' => [
            'Simple Tweezers',
            'Delicate extraction tool used for insects, fragments and fragile findings.',
            'tool',
            'metal',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'tweezers', 'durability' => 55], JSON_THROW_ON_ERROR),
        ],
        'simple_shovel' => [
            'Simple Shovel',
            'Basic digging tool used for roots, buried objects and shallow minerals.',
            'tool',
            'metal',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'shovel', 'durability' => 70], JSON_THROW_ON_ERROR),
        ],
        'simple_knife' => [
            'Simple Knife',
            'Basic scraping and cutting tool used for bark, resin and organic material.',
            'tool',
            'metal',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'knife', 'durability' => 65], JSON_THROW_ON_ERROR),
        ],
        'simple_flask' => [
            'Simple Flask',
            'Basic collection tool used for sap, venom, water and essences.',
            'tool',
            'essence',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'flask', 'durability' => 40], JSON_THROW_ON_ERROR),
        ],
        'simple_lockpick_kit' => [
            'Simple Lockpick Kit',
            'Basic lockpicking kit used to open old chests without a key.',
            'tool',
            'metal',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'lockpick_kit', 'durability' => 45], JSON_THROW_ON_ERROR),
        ],
        'old_key' => [
            'Old Key',
            'A simple key that can open early exploration chests.',
            'tool',
            'metal',
            0,
            1,
            ...
            0,
            1,
            json_encode(['tool_type' => 'key', 'key_tier' => 'old'], JSON_THROW_ON_ERROR),
        ],
        ...
        'explorer_gloves' => [
            'Explorer Gloves',
            'Reinforced gloves that reduce trap damage while opening containers.',
            'armor',
            'leather',
            0,
            1,
            ...
            0,
            1,
            json_encode(['trap_reduction' => 0.12, 'exploration_tag' => 'trap_mitigation'], JSON_THROW_ON_ERROR),
        ],
